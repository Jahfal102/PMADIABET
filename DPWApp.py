...
def main():
    ...
    BloodPressure=st.slider('BloodPressure level',min_value=0,max_value=140,value=80,step=1)
    SkinThickness=st.slider('SkinThickness value',min_value=0,max_value=100,value=40,step=1)
    Insulin=st.slider('Insulin level',min_value=0,max_value=1000,value=400,step=1)
